...
use ABC\Resources\Settings;
use ABC\Core\PhpBugsnare\Bugsnare;
use ABC\Core\Exception\AbcError;
use ABC\Core\Exception\AbcError500Exception;
...
class Configurator
{
    ...
    {    
        ...
        if (true === $this->config['middleware']) {
            $this->config['environment'] = include_once __DIR__ .'/../Resources/Environment.php';
        }
    ...
    */     
    ...
    {
        $langusge = '\ABC\Resources\Lang\\'. $this->config['debug']['language'];
    ...
    */     
    protected function setErrorMode()
    {
        ...
        } elseif (!empty($this->config['debug']['checkout'])) {
            define('ABC_DEBUG', true);
            include_once __DIR__ .'/../Debugger/catch.php';
        } 
    }  
