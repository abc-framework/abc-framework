...
$language_data = array(
    ...
    'KEYWORDS' => array(
        1 => array(
            ...
            'return','switch','throw','while', 'yield', 'new','private','protected', 
            'static', 'public', 'abstract','class','const','declare','extends',
            'function','global','trait','use','var','implements', 'interface',
            'echo','print', 'final', 'null'
            ),
        2 => array(
            '&amp;new','&lt;/script&gt;','&lt;script language',
            'namespace','self','instanceof', '__construct', '__call', '__callstatic',
            '__clone', '__destruct', '__get', '__set', '__isset', '__unset', '__sleep',
            '__wakeup', '__toString', '__invoke', '__set_state', '__clone', '__debuginfo', 
            'boolean', 'integer', 'int', 'float', 'double', 'real', 'string', 'array', 'iterable',
            'object', 'resource', 'callback', 'callable', 'void', 'clone'
            ),
        3 => array(
            ...
            'zlib_get_coding_type', 'forward_static_call_array'
            ),
        4 => array(
            ...
            'PHP_VERSION', 'true', '__NAMESPACE__', '__CLASS__', '__DIR__', '__FILE__', '__LINE__', 
    ...
    'STYLES' => array(
        ...
        'COMMENTS' => array(
            1 => 'color: #bbbc8b; font-style: italic;',
            2 => 'color: #bbbc8b; font-style: italic;',
            3 => 'color: #bbbc8b; font-style: italic;',
            4 => 'color: #bbbc8b; font-style: italic;',
            'MULTI' => 'color: #bbbc8b; font-style: italic;'
            ),
        'ESCAPE_CHAR' => array(
