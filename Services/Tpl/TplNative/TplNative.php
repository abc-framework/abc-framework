...
namespace ABC\Services\Tpl\TplNative;
...
{    
    ...
    */     
    public function selectTpl($tplName)
    {
        ...
        $tplName        = str_replace('\\', ABC_DS, $parts['dirname'] . ABC_DS . $parts['filename']);
    ...
    */     
    public function extendsTpl($block, $layout = 'index')
    {
        ...
        $this->html = $this->execute($this->tplDir . $parts['dirname'] . ABC_DS 
